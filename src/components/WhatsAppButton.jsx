...
export default function WhatsAppButton() {
  const [number, setNumber] = useState("919090000000");

  useEffect(() => {
    api.get("/public/config").then(r => {
      if (r.data?.whatsapp_number) setNumber(r.data.whatsapp_number);
    }).catch(() => {});
  }, []);

  const href = `https://wa.me/${number}?text=${encodeURIComponent("Hi! I need help with LudoCashPlay.")}`;
